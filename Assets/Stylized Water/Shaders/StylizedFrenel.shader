Shader "Stylized/WaterFrenel"
{
    Properties
    {
        ...
        _FresnelDirection("Fresnel direction", Vector) = (0,0,0,0)
    }
    SubShader
    {
        LOD 100
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                o.worldPosition.y += GetWaveHeight(o.worldPosition.xz);// *v.color.r;
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                //float fresnel2 = dot(i.worldNormal, float3(1, 0, 0));
                float fresnel = dot(i.worldNormal, _FresnelDirection.rgb);
                ...
                float fresnel2 = dot(i.worldNormal, float3(-_FresnelDirection.r, _FresnelDirection.g, _FresnelDirection.b));
                fresnel2 = saturate(1 - fresnel2);
                fresnel2 = pow(fresnel2, _FresnelExponent);
                fresnelColor += fresnel2 * _FresnelColor;

                color = color + fresnelColor;
